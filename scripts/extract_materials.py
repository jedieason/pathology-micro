...
CASES = [
 ...
 dict(id='PA0313', lesson=1, answerPage=29, pages=[26,27,28,30], organ='Intestine/colon', diagnosis='Necrotizing enterocolitis',
 description='1. Coagulative necrosis with hemorrhage – mucosal and transmural (impending perforation)\n2. Chronic changes: strictures, crypt distortion, reactive epithelial cells (本片無)',notes='',keywords=['Coagulative necrosis with hemorrhage']),
